...
void setup() {
  ...
  if (logger.begin()) {
    ...
    logger.println(F(
      ...
      "imu_Rvel,imu_Lvel,imu_vel_1,imu_vel_2,imu_vel_3,imu_vel_4,freq_avg,"
...
// ################################
    ...
    // 4) 下发电机命令（MIT/力矩等，按你库的 send_cmd 接口）
      ...
      // 下发 Servo Current
      sig_m1.send_current_A(1);
      sig_m2.send_current_A(1);
    #endif
    ...
    if (logger.isOpen()) {
      ...
      logger.print(imu.VTX1, 4);               logger.print(',');
      logger.print(imu.VTX2, 4);               logger.print(',');
      logger.print(imu.VTX3, 4);               logger.print(',');
      logger.print(imu.VTX4, 4);               logger.print(',');
